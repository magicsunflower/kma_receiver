...
/* TxPower define(Accuracy:锟斤拷1dBm) */
...
// v5.x
#define TGAP_ADV_TX_POWER                       25  //!< Indicates the maximum power level Range: -127 锟斤拷 N 锟斤拷 +126 Units: dBm.Default 127(Host has no preference).
